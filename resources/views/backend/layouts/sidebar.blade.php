<ul class="navbar-nav bg-sidebar sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  {{-- Delivery Partner --}}
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#deliveryCollapse" aria-expanded="true"
      aria-controls="deliveryCollapse">
      <i class="fas fa-truck"></i>
      <span>Delivery Partner</span>
    </a>
    <div id="deliveryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Delivery Options:</h6>
        <a class="collapse-item" href="{{route('delivery-partners.index')}}">Delivery Partners</a>
        <a class="collapse-item" href="{{route('delivery-partners.create')}}">Add Delivery Partners</a>
      </div>
    </div>
  </li>
